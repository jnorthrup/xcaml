...
/**
 * <p>
 * Java class for ADOData_Type complex type.
 * 
 * <p>
...
@XmlType(name = "ADOData_Type", propOrder = {"any"})
public class ADODataType {
  ...
  public ADODataType withAny(Object... values) {
    if (values != null) {
  ...
  public ADODataType withAny(Collection<Object> values) {
    if (values != null) {
