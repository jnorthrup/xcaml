...
@XmlSeeAlso({
    FieldType.class, ScratchType.class, CharType.class, ParaType.class, LayerType.class,
    ReviewerType.class, AnnotationType.class, TabsType.class, PolylineToType.class,
    EllipseType.class, SplineKnotType.class, LineToType.class, SplineStartType.class,
    MoveToType.class, InfiniteLineType.class, ArcToType.class, NURBSToType.class,
