...
public class ObligationExpressionsType {
   ...
   * the obligationExpression property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ObligationExpressionType }
   * 
   * 
   */
  ...
  public ObligationExpressionsType withObligationExpression(ObligationExpressionType... values) {
    if (values != null) {
      for (ObligationExpressionType value : values) {
        getObligationExpression().add(value);
      }
    }
    return this;
  }

  public ObligationExpressionsType withObligationExpression(
      Collection<ObligationExpressionType> values) {
    if (values != null) {
      getObligationExpression().addAll(values);
    }
    return this;
  }
