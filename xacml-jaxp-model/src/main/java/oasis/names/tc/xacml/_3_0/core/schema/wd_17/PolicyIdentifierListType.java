...
public class PolicyIdentifierListType {
   ...
   * {@link IdReferenceType }{@code >} {@link javax.xml.bind.JAXBElement }{@code <}{@link IdReferenceType }{@code >}
   * 
   * 
   */
  ...
  public PolicyIdentifierListType withPolicyIdReferenceOrPolicySetIdReference(
      JAXBElement<IdReferenceType>... values) {
    if (values != null) {
  ...
  public PolicyIdentifierListType withPolicyIdReferenceOrPolicySetIdReference(
      Collection<JAXBElement<IdReferenceType>> values) {
    if (values != null) {
