...
public class ResponseType implements Cloneable {
  ...
  protected transient List<ResultType> result_RO = null;
  ...
  public ResponseType clone() throws CloneNotSupportedException {
    ...
    newObject.result_RO =
        ((result == null) ? null : Collections.unmodifiableList(newObject.result));
    return newObject;
  }

  public List<ResultType> getResult() {
    if (this.result == null) {
      this.result = new ArrayList<ResultType>();
    }
    if (this.result_RO == null) {
      this.result_RO = ((result == null) ? null : Collections.unmodifiableList(this.result));
    }
    return this.result_RO;
  }
  ...
  public static class Builder<TParentBuilder> {
    ...
    protected <P extends ResponseType> P init(final P product) {
      ...
      product.result_RO = ((result == null) ? null : Collections.unmodifiableList(product.result));
      return product;
    }
