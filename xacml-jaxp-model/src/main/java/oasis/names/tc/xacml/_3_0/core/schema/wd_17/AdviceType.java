...
public class AdviceType {
  ...
  public AdviceType withAttributeAssignment(AttributeAssignmentType... values) {
    if (values != null) {
  ...
  public AdviceType withAttributeAssignment(Collection<AttributeAssignmentType> values) {
    if (values != null) {
  ...
  public AdviceType withAdviceId(String value) {
    setAdviceId(value);
    return this;
  }
