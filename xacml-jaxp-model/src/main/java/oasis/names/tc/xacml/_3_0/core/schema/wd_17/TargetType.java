...
public class TargetType implements Cloneable {
  ...
  protected transient List<AnyOfType> anyOf_RO = null;
  ...
  public TargetType clone() throws CloneNotSupportedException {
    ...
    newObject.anyOf_RO = ((anyOf == null) ? null : Collections.unmodifiableList(newObject.anyOf));
    return newObject;
  }

  public List<AnyOfType> getAnyOf() {
    if (this.anyOf == null) {
      this.anyOf = new ArrayList<AnyOfType>();
    }
    if (this.anyOf_RO == null) {
      this.anyOf_RO = ((anyOf == null) ? null : Collections.unmodifiableList(this.anyOf));
    }
    return this.anyOf_RO;
  }
  ...
  public static class Builder<TParentBuilder> {
    ...
    protected <P extends TargetType> P init(final P product) {
      ...
      product.anyOf_RO = ((anyOf == null) ? null : Collections.unmodifiableList(product.anyOf));
      return product;
    }
