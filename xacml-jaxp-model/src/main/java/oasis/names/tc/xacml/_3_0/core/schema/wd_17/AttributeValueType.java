...
public class AttributeValueType {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link Object } {@link String } {@link org.w3c.dom.Element }
   * 
   * 
   */
  ...
  public AttributeValueType withContent(Object... values) {
    if (values != null) {
  ...
  public AttributeValueType withContent(Collection<Object> values) {
    if (values != null) {
  ...
  public AttributeValueType withDataType(String value) {
    setDataType(value);
    return this;
  }
