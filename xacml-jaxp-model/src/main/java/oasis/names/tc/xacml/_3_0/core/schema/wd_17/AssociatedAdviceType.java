...
public class AssociatedAdviceType implements Cloneable {
  ...
  protected transient List<AdviceType> advice_RO = null;
  ...
  public AssociatedAdviceType clone() throws CloneNotSupportedException {
    ...
    newObject.advice_RO =
        ((advice == null) ? null : Collections.unmodifiableList(newObject.advice));
    return newObject;
  }
  ...
  public List<AdviceType> getAdvice() {
    ...
    if (this.advice_RO == null) {
      this.advice_RO = ((advice == null) ? null : Collections.unmodifiableList(this.advice));
    }
    return this.advice_RO;
  }
  ...
  public static class Builder<TParentBuilder> {
    ...
    protected <P extends AssociatedAdviceType> P init(final P product) {
      ...
      product.advice_RO = ((advice == null) ? null : Collections.unmodifiableList(product.advice));
      return product;
    }
