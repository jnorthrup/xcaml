...
public class AssociatedAdviceType {
  ...
  public AssociatedAdviceType withAdvice(AdviceType... values) {
    if (values != null) {
      for (AdviceType value : values) {
        getAdvice().add(value);
      }
    }
    return this;
  ...
  public AssociatedAdviceType withAdvice(Collection<AdviceType> values) {
    if (values != null) {
