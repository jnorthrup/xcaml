...
public class CombinerParametersType implements Cloneable {
  ...
  protected transient List<CombinerParameterType> combinerParameter_RO = null;
  ...
  public CombinerParametersType clone() throws CloneNotSupportedException {
    ...
    newObject.combinerParameter_RO =
        ((combinerParameter == null) ? null : Collections
            .unmodifiableList(newObject.combinerParameter));
    return newObject;
  }

  public List<CombinerParameterType> getCombinerParameter() {
    if (this.combinerParameter == null) {
      this.combinerParameter = new ArrayList<CombinerParameterType>();
    }
    if (this.combinerParameter_RO == null) {
      this.combinerParameter_RO =
          ((combinerParameter == null) ? null : Collections
              .unmodifiableList(this.combinerParameter));
    }
    return this.combinerParameter_RO;
  }
  ...
  public static class Builder<TParentBuilder> {
    ...
    protected <P extends CombinerParametersType> P init(final P product) {
      ...
      product.combinerParameter_RO =
          ((combinerParameter == null) ? null : Collections
              .unmodifiableList(product.combinerParameter));
      return product;
    }
