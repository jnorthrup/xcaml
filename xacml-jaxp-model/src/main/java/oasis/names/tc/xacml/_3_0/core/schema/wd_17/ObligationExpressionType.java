...
public class ObligationExpressionType {
    ...
    public ObligationExpressionType withAttributeAssignmentExpression(AttributeAssignmentExpressionType... values) {
        if (values!= null) {
    ...
    public ObligationExpressionType withAttributeAssignmentExpression(Collection<AttributeAssignmentExpressionType> values) {
        if (values!= null) {
    ...
    public ObligationExpressionType withObligationId(String value) {
        setObligationId(value);
        return this;
    }

    public ObligationExpressionType withFulfillOn(EffectType value) {
        setFulfillOn(value);
        return this;
    }
