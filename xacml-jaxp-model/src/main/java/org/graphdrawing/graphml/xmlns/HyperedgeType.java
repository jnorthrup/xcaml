...
@XmlType(name = "hyperedge.type", propOrder = {"desc", "dataOrEndpoint", "graph"})
public class HyperedgeType {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link DataType } {@link EndpointType }
   * 
   * 
   */
   ...
   * 
   * @param value allowed object is {@link GraphType }
   * 
   */
  ...
  public HyperedgeType withDesc(String value) {
    setDesc(value);
    return this;
  }

  public HyperedgeType withDataOrEndpoint(Object... values) {
    if (values != null) {
      for (Object value : values) {
        getDataOrEndpoint().add(value);
      }
    }
    return this;
  }

  public HyperedgeType withDataOrEndpoint(Collection<Object> values) {
    if (values != null) {
      getDataOrEndpoint().addAll(values);
    }
    return this;
  }

  public HyperedgeType withGraph(GraphType value) {
    setGraph(value);
    return this;
  }

  public HyperedgeType withId(String value) {
    setId(value);
    return this;
  }
