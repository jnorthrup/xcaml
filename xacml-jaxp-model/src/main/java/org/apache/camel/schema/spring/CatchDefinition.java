...
/**
 * <p>
 * Java class for catchDefinition complex type.
 * 
 * <p>
...
@XmlType(name = "catchDefinition", propOrder = {
    "exception", "onWhen", "handled", "aopOrAggregateOrBean"})
public class CatchDefinition extends ProcessorDefinition {
  ...
  @Override
  public CatchDefinition withDescription(DescriptionDefinition value) {
