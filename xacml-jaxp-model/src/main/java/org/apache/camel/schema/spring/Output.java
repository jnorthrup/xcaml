...
@XmlType(name = "output", propOrder = {"aopOrAggregateOrBean"})
@XmlSeeAlso({
    AopDefinition.class, InterceptDefinition.class, PolicyDefinition.class,
    SamplingDefinition.class, PipelineDefinition.class, TryDefinition.class,
    InterceptSendToEndpointDefinition.class, OtherwiseDefinition.class, FinallyDefinition.class,
    TransactedDefinition.class, ThreadsDefinition.class, MulticastDefinition.class})
public class Output extends ProcessorDefinition {
  ...
  @Override
  public Output withDescription(DescriptionDefinition value) {
