...
@XmlSeeAlso({
    AopDefinition.class, FinallyDefinition.class, InterceptDefinition.class,
    InterceptSendToEndpointDefinition.class, MulticastDefinition.class, PolicyDefinition.class,
    SamplingDefinition.class, ThreadsDefinition.class, TransactedDefinition.class,
    TryDefinition.class, OtherwiseElement.class, PipelineElement.class})
