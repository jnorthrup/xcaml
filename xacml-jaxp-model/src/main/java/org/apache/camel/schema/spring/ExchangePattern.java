...
/**
 * <p>
 * Java class for exchangePattern.
 * 
 * <p>
...
public enum ExchangePattern {
  ...
  @XmlEnumValue("InOnly")
  IN_ONLY("InOnly"), @XmlEnumValue("RobustInOnly")
  ROBUST_IN_ONLY("RobustInOnly"), @XmlEnumValue("OutOptionalIn")
  OUT_OPTIONAL_IN("OutOptionalIn"), @XmlEnumValue("OutIn")
  OUT_IN("OutIn"), @XmlEnumValue("RobustOutOnly")
  ROBUST_OUT_ONLY("RobustOutOnly"), @XmlEnumValue("InOptionalOut")
  IN_OPTIONAL_OUT("InOptionalOut"), @XmlEnumValue("OutOnly")
  OUT_ONLY("OutOnly"), @XmlEnumValue("InOut")
  IN_OUT("InOut");
