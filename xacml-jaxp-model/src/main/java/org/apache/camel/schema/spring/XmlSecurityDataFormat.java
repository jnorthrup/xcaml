...
/**
 * <p>
 * Java class for xmlSecurityDataFormat complex type.
 * 
 * <p>
 ...
 *       &lt;attribute name="addKeyValueForEncryptedKey" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class XmlSecurityDataFormat extends DataFormat {
  ...
  @XmlAttribute(name = "addKeyValueForEncryptedKey")
  protected Boolean addKeyValueForEncryptedKey;
  ...
  /**
   * Gets the value of the addKeyValueForEncryptedKey property.
   * 
   * @return possible object is {@link Boolean }
   * 
   */
  ...
  /**
   * Sets the value of the addKeyValueForEncryptedKey property.
   * 
   * @param value allowed object is {@link Boolean }
   * 
   */
  public void setAddKeyValueForEncryptedKey(Boolean value) {
    this.addKeyValueForEncryptedKey = value;
  }

  public XmlSecurityDataFormat withXmlCipherAlgorithm(String value) {
    setXmlCipherAlgorithm(value);
    return this;
  }

  public XmlSecurityDataFormat withPassPhrase(String value) {
    setPassPhrase(value);
    return this;
  }

  public XmlSecurityDataFormat withSecureTag(String value) {
    setSecureTag(value);
    return this;
  }

  public XmlSecurityDataFormat withSecureTagContents(Boolean value) {
    setSecureTagContents(value);
    return this;
  }

  public XmlSecurityDataFormat withKeyCipherAlgorithm(String value) {
    setKeyCipherAlgorithm(value);
    return this;
  }

  public XmlSecurityDataFormat withRecipientKeyAlias(String value) {
    setRecipientKeyAlias(value);
    return this;
  }

  public XmlSecurityDataFormat withKeyOrTrustStoreParametersId(String value) {
    setKeyOrTrustStoreParametersId(value);
    return this;
  }

  public XmlSecurityDataFormat withKeyPassword(String value) {
    setKeyPassword(value);
    return this;
  }

  public XmlSecurityDataFormat withDigestAlgorithm(String value) {
    setDigestAlgorithm(value);
    return this;
  }

  public XmlSecurityDataFormat withMgfAlgorithm(String value) {
    setMgfAlgorithm(value);
    return this;
  }

  public XmlSecurityDataFormat withAddKeyValueForEncryptedKey(Boolean value) {
    setAddKeyValueForEncryptedKey(value);
    return this;
  }

  @Override
  public XmlSecurityDataFormat withId(String value) {
    setId(value);
    return this;
  }
