...
/**
 * <p>
 * Java class for onExceptionDefinition complex type.
 * 
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="onExceptionDefinition">
 *   &lt;complexContent>
 ...
 *         &lt;element name="retryWhile" type="{http://camel.apache.org/schema/spring}expressionSubElementDefinition" minOccurs="0"/>
 *         &lt;element ref="{http://camel.apache.org/schema/spring}redeliveryPolicy" minOccurs="0"/>
 *         &lt;element name="handled" type="{http://camel.apache.org/schema/spring}expressionSubElementDefinition" minOccurs="0"/>
 *         &lt;element name="continued" type="{http://camel.apache.org/schema/spring}expressionSubElementDefinition" minOccurs="0"/>
...
@XmlType(name = "onExceptionDefinition", propOrder = {
    "exception", "onWhen", "retryWhile", "redeliveryPolicy", "handled", "continued",
    "aopOrAggregateOrBean"})
public class OnExceptionDefinition extends ProcessorDefinition {
  ...
  /**
   * Gets the value of the retryWhile property.
   * 
  ...
  /**
   * Sets the value of the retryWhile property.
   * 
   * @param value allowed object is {@link ExpressionSubElementDefinition }
   * 
   */
  public void setRetryWhile(ExpressionSubElementDefinition value) {
    this.retryWhile = value;
  }

  /**
   * Gets the value of the redeliveryPolicy property.
   * 
   * @return possible object is {@link RedeliveryPolicyDefinition }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RedeliveryPolicyDefinition }
   * 
   */
   ...
   * 
   */
  public void setContinued(ExpressionSubElementDefinition value) {
  ...
  public OnExceptionDefinition withException(String... values) {
    if (values != null) {
  ...
  public OnExceptionDefinition withException(Collection<String> values) {
    if (values != null) {
  ...
  public OnExceptionDefinition withOnWhen(WhenDefinition value) {
    setOnWhen(value);
    return this;
  }

  public OnExceptionDefinition withRetryWhile(ExpressionSubElementDefinition value) {
    setRetryWhile(value);
    return this;
  }

  public OnExceptionDefinition withRedeliveryPolicy(RedeliveryPolicyDefinition value) {
    setRedeliveryPolicy(value);
    return this;
  }

  public OnExceptionDefinition withHandled(ExpressionSubElementDefinition value) {
    setHandled(value);
    return this;
  }

  public OnExceptionDefinition withContinued(ExpressionSubElementDefinition value) {
    setContinued(value);
    return this;
  }

  public OnExceptionDefinition withAopOrAggregateOrBean(ProcessorDefinition... values) {
    if (values != null) {
  ...
  public OnExceptionDefinition withAopOrAggregateOrBean(Collection<ProcessorDefinition> values) {
    if (values != null) {
  ...
  public OnExceptionDefinition withRedeliveryPolicyRef(String value) {
    setRedeliveryPolicyRef(value);
    return this;
  }

  public OnExceptionDefinition withOnRedeliveryRef(String value) {
    setOnRedeliveryRef(value);
    return this;
  }

  public OnExceptionDefinition withUseOriginalMessage(Boolean value) {
    setUseOriginalMessage(value);
    return this;
  }

  @Override
  public OnExceptionDefinition withInheritErrorHandler(Boolean value) {
    setInheritErrorHandler(value);
    return this;
  }

  @Override
  public OnExceptionDefinition withDescription(DescriptionDefinition value) {
    setDescription(value);
    return this;
  }

  @Override
  public OnExceptionDefinition withCustomId(Boolean value) {
    setCustomId(value);
    return this;
  }

  @Override
  public OnExceptionDefinition withId(String value) {
    setId(value);
    return this;
  }
