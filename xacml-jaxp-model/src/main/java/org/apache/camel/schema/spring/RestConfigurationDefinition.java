...
/**
 * <p>
 * Java class for restConfigurationDefinition complex type.
 * 
 * <p>
...
@XmlType(name = "restConfigurationDefinition", propOrder = {
    "componentProperty", "endpointProperty", "consumerProperty", "dataFormatProperty",
    "corsHeaders"})
public class RestConfigurationDefinition {
   ...
   * the componentProperty property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link RestPropertyDefinition }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
   * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
   * the dataFormatProperty property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * 
   * @return possible object is {@link RestHostNameResolver }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RestHostNameResolver }
   * 
   */
  ...
  public RestConfigurationDefinition withDataFormatProperty(
      Collection<RestPropertyDefinition> values) {
    if (values != null) {
