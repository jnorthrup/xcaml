...
/**
 * <p>
 * Java class for packageScanDefinition complex type.
 * 
 * <p>
...
@XmlType(name = "packageScanDefinition", propOrder = {"_package", "excludes", "includes"})
public class PackageScanDefinition {
  ...
  public PackageScanDefinition withPackage(String... values) {
    if (values != null) {
  ...
  public PackageScanDefinition withPackage(Collection<String> values) {
    if (values != null) {
  ...
  public PackageScanDefinition withExcludes(String... values) {
    if (values != null) {
      for (String value : values) {
  ...
  public PackageScanDefinition withExcludes(Collection<String> values) {
    if (values != null) {
  ...
  public PackageScanDefinition withIncludes(String... values) {
    if (values != null) {
      for (String value : values) {
  ...
  public PackageScanDefinition withIncludes(Collection<String> values) {
    if (values != null) {
