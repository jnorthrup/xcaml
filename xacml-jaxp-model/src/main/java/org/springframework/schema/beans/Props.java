...
public class Props extends PropsType {
  ...
  public Props withMerge(DefaultableBoolean value) {
    setMerge(value);
    return this;
  }

  @Override
  public Props withProp(Prop... values) {
    if (values != null) {
  ...
  @Override
  public Props withProp(Collection<Prop> values) {
    if (values != null) {
  ...
  @Override
  public Props withValueType(String value) {
    setValueType(value);
    return this;
  }
