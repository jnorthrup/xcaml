...
public class Map extends MapType {
  ...
  public Map withMerge(DefaultableBoolean value) {
    setMerge(value);
    return this;
  }

  @Override
  public Map withDescription(Description value) {
    setDescription(value);
    return this;
  }

  @Override
  public Map withEntry(EntryType... values) {
    if (values != null) {
  ...
  @Override
  public Map withEntry(Collection<EntryType> values) {
    if (values != null) {
  ...
  @Override
  public Map withKeyType(String value) {
    setKeyType(value);
    return this;
  }

  @Override
  public Map withValueType(String value) {
    setValueType(value);
    return this;
  }
