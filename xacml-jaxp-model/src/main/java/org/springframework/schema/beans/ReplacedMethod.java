...
public class ReplacedMethod {
  ...
  public ReplacedMethod withArgType(ArgType... values) {
    if (values != null) {
  ...
  public ReplacedMethod withArgType(Collection<ArgType> values) {
    if (values != null) {
  ...
  public ReplacedMethod withName(String value) {
    setName(value);
    return this;
  }

  public ReplacedMethod withReplacer(String value) {
    setReplacer(value);
    return this;
  }
