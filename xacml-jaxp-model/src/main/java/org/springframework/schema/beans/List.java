...
public class List extends ListOrSetType {
  ...
  public List withMerge(DefaultableBoolean value) {
    setMerge(value);
    return this;
  }

  @Override
  public List withDescription(Description value) {
    setDescription(value);
    return this;
  }

  @Override
  public List withBeanOrRefOrIdref(Object... values) {
    if (values != null) {
  ...
  @Override
  public List withBeanOrRefOrIdref(Collection<Object> values) {
    if (values != null) {
  ...
  @Override
  public List withValueType(String value) {
    setValueType(value);
    return this;
  }
