...
public class Array extends ListOrSetType {
  ...
  public Array withMerge(DefaultableBoolean value) {
    setMerge(value);
    return this;
  }

  @Override
  public Array withDescription(Description value) {
    setDescription(value);
    return this;
  }

  @Override
  public Array withBeanOrRefOrIdref(Object... values) {
    if (values != null) {
  ...
  @Override
  public Array withBeanOrRefOrIdref(Collection<Object> values) {
    if (values != null) {
  ...
  @Override
  public Array withValueType(String value) {
    setValueType(value);
    return this;
  }
