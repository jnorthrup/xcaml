...
/**
 * <p>
 * Java class for SolutionXML_Type complex type.
 * 
 * <p>
...
@XmlType(name = "SolutionXML_Type", propOrder = {"content"})
public class SolutionXMLType {
  ...
  public SolutionXMLType withContent(Object... values) {
    if (values != null) {
  ...
  public SolutionXMLType withContent(Collection<Object> values) {
    if (values != null) {
  ...
  public SolutionXMLType withName(String value) {
    setName(value);
    return this;
  }
