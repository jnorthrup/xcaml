...
/**
 * <p>
 * Java class for RibbonX_Type complex type.
 * 
 * <p>
...
@XmlType(name = "RibbonX_Type", propOrder = {"any"})
public class RibbonXType {
  ...
  public RibbonXType withAny(Object... values) {
    if (values != null) {
  ...
  public RibbonXType withAny(Collection<Object> values) {
    if (values != null) {
