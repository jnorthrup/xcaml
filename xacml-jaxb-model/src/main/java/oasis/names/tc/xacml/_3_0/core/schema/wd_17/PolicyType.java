...
public class PolicyType {
    ...
    public PolicyType withCombinerParametersOrRuleCombinerParametersOrVariableDefinition(Object... values) {
        if (values!= null) {
    ...
    public PolicyType withCombinerParametersOrRuleCombinerParametersOrVariableDefinition(Collection<Object> values) {
        if (values!= null) {
