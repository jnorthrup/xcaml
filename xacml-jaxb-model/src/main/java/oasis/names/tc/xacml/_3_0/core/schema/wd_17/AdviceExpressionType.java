...
public class AdviceExpressionType {
    ...
    public AdviceExpressionType withAttributeAssignmentExpression(AttributeAssignmentExpressionType... values) {
        if (values!= null) {
    ...
    public AdviceExpressionType withAttributeAssignmentExpression(Collection<AttributeAssignmentExpressionType> values) {
        if (values!= null) {
