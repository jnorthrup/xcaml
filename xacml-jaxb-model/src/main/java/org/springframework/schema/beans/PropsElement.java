    ...
    extends PropsType
{
    ...
    public PropsElement withMerge(DefaultableBoolean value) {
        setMerge(value);
        return this;
    }

    @Override
    public PropsElement withProp(PropElement... values) {
        if (values!= null) {
    ...
    @Override
    public PropsElement withProp(Collection<PropElement> values) {
        if (values!= null) {
    ...
    @Override
    public PropsElement withValueType(String value) {
        setValueType(value);
        return this;
    }
