...
/**
 * <p>Java class for unmarshalDefinition complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="unmarshalDefinition">
 *   &lt;complexContent>
...
@XmlType(name = "unmarshalDefinition", propOrder = {
    "avro",
    "base64",
    "beanio",
    "bindy",
    ...
    extends NoOutputDefinition
{
    ...
    public UnmarshalDefinition withAvro(AvroDataFormat value) {
        setAvro(value);
        return this;
    }
    ...
    public UnmarshalDefinition withBindy(BindyDataFormat value) {
        setBindy(value);
        return this;
    }

    public UnmarshalDefinition withCastor(CastorDataFormat value) {
        setCastor(value);
        return this;
    }

    public UnmarshalDefinition withCrypto(CryptoDataFormat value) {
        setCrypto(value);
        return this;
    }

    public UnmarshalDefinition withCsv(CsvDataFormat value) {
        setCsv(value);
        return this;
    }

    public UnmarshalDefinition withCustom(CustomDataFormat value) {
        setCustom(value);
        return this;
    }

    public UnmarshalDefinition withFlatpack(FlatpackDataFormat value) {
        setFlatpack(value);
        return this;
    }

    public UnmarshalDefinition withGzip(GzipDataFormat value) {
        setGzip(value);
        return this;
    }

    public UnmarshalDefinition withHl7(Hl7DataFormat value) {
        setHl7(value);
        return this;
    }
    ...
    public UnmarshalDefinition withJibx(JibxDataFormat value) {
        setJibx(value);
        return this;
    }
    ...
    public UnmarshalDefinition withProtobuf(ProtobufDataFormat value) {
        setProtobuf(value);
        return this;
    }

    public UnmarshalDefinition withRss(RssDataFormat value) {
        setRss(value);
        return this;
    }

    public UnmarshalDefinition withSecureXML(XmlSecurityDataFormat value) {
        setSecureXML(value);
        return this;
    }

    public UnmarshalDefinition withSerialization(SerializationDataFormat value) {
        setSerialization(value);
        return this;
    }

    public UnmarshalDefinition withSoapjaxb(SoapJaxbDataFormat value) {
        setSoapjaxb(value);
        return this;
    }
    ...
    public UnmarshalDefinition withTidyMarkup(TidyMarkupDataFormat value) {
        setTidyMarkup(value);
        return this;
    }

    public UnmarshalDefinition withXmlBeans(XmlBeansDataFormat value) {
        setXmlBeans(value);
        return this;
    }

    public UnmarshalDefinition withXmljson(XmlJsonDataFormat value) {
        setXmljson(value);
        return this;
    }

    public UnmarshalDefinition withXmlrpc(XmlRpcDataFormat value) {
        setXmlrpc(value);
        return this;
    }
    ...
    public UnmarshalDefinition withPgp(PgpDataFormat value) {
        setPgp(value);
        return this;
    }

    public UnmarshalDefinition withZip(ZipDataFormat value) {
        setZip(value);
        return this;
    }

    public UnmarshalDefinition withZipFile(ZipFileDataFormat value) {
        setZipFile(value);
        return this;
    }

    public UnmarshalDefinition withRef(String value) {
        setRef(value);
        return this;
    }

    @Override
    public UnmarshalDefinition withInheritErrorHandler(Boolean value) {
    ...
    @Override
    public UnmarshalDefinition withCustomId(Boolean value) {
        setCustomId(value);
        return this;
    }

    @Override
    public UnmarshalDefinition withId(String value) {
        setId(value);
        return this;
    }
