...
@XmlType(name = "", propOrder = {"_package", "excludes", "includes"})
@XmlRootElement(name = "packageScan")
public class PackageScanElement {
  ...
  public PackageScanElement withPackage(String... values) {
    if (values != null) {
  ...
  public PackageScanElement withPackage(Collection<String> values) {
    if (values != null) {
  ...
  public PackageScanElement withExcludes(String... values) {
    if (values != null) {
      for (String value : values) {
  ...
  public PackageScanElement withExcludes(Collection<String> values) {
    if (values != null) {
  ...
  public PackageScanElement withIncludes(String... values) {
    if (values != null) {
      for (String value : values) {
  ...
  public PackageScanElement withIncludes(Collection<String> values) {
    if (values != null) {
