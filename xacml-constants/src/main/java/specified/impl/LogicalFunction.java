 ...
 */
public enum LogicalFunction implements F {
  /**
   ...
   * evaluates to "True", then the result of the expression SHALL be "False". If the argument evaluates to "False", then
   * the result of the expression SHALL be "True".
   * <p>
   * Note: When evaluating and, or, or n-of, it MAY NOT be necessary to attempt a full evaluation of each argument in
   * order to determine whether the evaluation of the argument would result in "Indeterminate". Analysis of the argument
   * regarding the availability of its attributes, or other analysis regarding errors, such as "divide-by-zero", may
